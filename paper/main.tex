...
complaint pushed the intended fault aside on the binary projects, and so \emph{overstated} the
...
that does not match the real solver can quietly distort the result. We checked the opposite
direction too: the agents kept
...
Wilson $95\%$ intervals for the ablation proportions (Table~\ref{tab:results}); these stay reliable
at small samples and near $0$ or $100\%$, where the usual normal approximation does not. The
