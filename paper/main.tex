...
overhead is negligible. The compute at stake dwarfs that overhead: the test-case run of
Section~\ref{sec:motivation} held eight A100 GPUs for $28$~minutes (about $3.7$ GPU-hours) and
returned a product that had to be discarded, while the static check that catches the fault takes
...
only afterwards. The multi-judge check \emph{is}
